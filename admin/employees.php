...
<div class="card">
   ...
   $sql="select * from employee_list LEFT JOIN department_list ON employee_list.department_id = department_list.department_id";
              $qry = $conn->query($sql);
              $i = 1;
