        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label for="employee_code" class="control-label">Employee Code/ID</label>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="type" id="Manager" value="Manager" required <?php echo isset($type) && $type == 'Admin' ? "checked" : "" ?>>
                ...
                <div class="form-group">
                    ...
                    <?php if(isset($book_id)): ?>
                        <small class="text-info"><i>Upload Only if you update employee's image.</i></small>
                    <?php endif; ?>
                </div>
                <div class="form-group">
