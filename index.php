...
if(!isset($_SESSION['employee_id']) || (isset($_SESSION['employee_id']) <= 0)){
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <?php if(isset($_SESSION['employee_id']) && $_SESSION['employee_id'] > 0): ?>
                    <?php if($_SESSION['type'] =="Manager"  ): ?>
                    <li class="nav-item">
                        <a class="nav-link <?php echo $page == "tasks" ? "active" :"" ?>" href="./?page=tasks"><i class="fa fa-tasks"></i> Tasks</a>
                    </li>
                    <?php else: ?>
                    <li class="nav-item">
                        <a class="nav-link <?php echo $page == "assigned_tasks" ? "active" :"" ?>" href="./?page=assigned_tasks"><i class="fa fa-tasks"></i> Assigned Tasks</a>
                    </li>
                    <?php endif; ?>
                    <?php endif; ?>
            ...
            <div class="dropdown">
                <button class="btn btn-secondary dropdown-toggle bg-transparent  text-light border-0" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                   <img src="<?php echo "./uploads/employees/{$_SESSION['employee_id']}.png?v=".(strtotime($_SESSION['date_updated'])) ?>" alt="avatar" id="top-avatar"> Hello <?php echo $_SESSION['fullname'] ?>
                </button>
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    <li><a class="dropdown-item" href="./?page=manage_account">Manage Account</a></li>
                    <li><a class="dropdown-item" href="Actions.php?a=employee_logout">Logout</a></li>
                </ul>
            </div>
            <?php else: ?>
