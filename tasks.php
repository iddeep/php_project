                    ...
                    <th class="text-center py-0 px-1">
                        <div class="btn-group" role="group">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                ...
                                <li><a class="dropdown-item edit_data" data-id = '<?php echo $row['task_id'] ?>' data-code='<?php echo $row['task_code'] ?>' href="javascript:void(0)">Edit</a></li>
...
<script>
    $(function(){
        $('#create_new').click(function(){
            uni_modal('Create New Task',"manage_task.php",'large')
        })
        $('.edit_data').click(function(){
            uni_modal('Edit Task Details',"manage_task.php?id="+$(this).attr('data-id'),'large')
        })
