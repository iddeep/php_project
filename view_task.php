...
if($_SESSION['type'] == 'Staff' && !in_array($_SESSION['employee_id'],$assignees)){
    echo "<script>alert('Access Deneid! You are not assigned to this task.'); location.replace(document.referrer)</script>";
}else if($_SESSION['type'] == 'Manager' && $_SESSION['department_id'] != $department_id){
    echo "<script>alert('Access Deneid! This task is for diffenerent Department'); location.replace(document.referrer)</script>";
}
...
<div class="py-5">
    <div class="col-12">
        <div class="row">
            ...
            <div class="col-md-4">
                <?php if($_SESSION['type'] == 'Manager' && $_SESSION['department_id'] && $department_id): ?>
                <center>
                    <button class="btn btn-primary rounded-pill col-sm-8" type="button" id="edit_task"><i class="fa fa-edit"></i> Edit Task</button>
                </center>
                <div class="cleafix mb-2"></div>
                <?php endif; ?>
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="w-100 d-flex justify-content-between align-items-center">
                    ...
                    <button class="btn btn-primary rounded-0" type="button" id="new_comment"><i class="fa fa-plus"></i> Add New</button>
                </div>
                <hr>
                <?php
